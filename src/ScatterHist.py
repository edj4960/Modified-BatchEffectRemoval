...
def scatterHist(x1,x2, y1,y2, axis1='', axis2=''):
    ...
    axHistx.hist(x1, bins=bins, color = 'blue', density=True, stacked = True, histtype='step' ) #, density=True
    axHisty.hist(x2, bins=bins, orientation='horizontal', density=True, color = 'blue', stacked = True, histtype='step')
    axHistx.hist(y1, bins=bins, color = 'red', density=True, stacked = True, histtype='step')
    axHisty.hist(y2, bins=bins, orientation='horizontal', density=True, color = 'red', stacked = True, histtype='step')
